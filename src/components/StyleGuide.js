...
export default class StyleGuide extends Component {
    render() {
      ...
      <div className="nk-main">
        ...
        */}
          <div className="nk-gap-2" />
          <div className="nk-countdown nk-countdown-center" data-end="2018-11-26 08:20" data-timezone="EST" />
          {/* END: Countdown */}
          {/* START: Info Boxes */}
          <div className="nk-gap-2" />
          ...
          <div className="row vertical-gap">
            ...
            <div className="col-lg-6">
              ...
              <div className="nk-gap" />
              {/* START: MailChimp Signup Form */}
              <form action="//nkdev.us11.list-manage.com/subscribe/post?u=d433160c0c43dcf8ecd52402f&id=7eafafe8f0" method="post" className="nk-mchimp nk-form nk-form-style-1 validate" target="_blank">
                <div className="input-group">
                  <input type="email" defaultValue name="EMAIL" className="required email form-control" placeholder="Email *" />
