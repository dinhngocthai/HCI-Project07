                  ...
                  <div className="row vertical-gap">
                    ...
                    <div className="col-md-7 col-lg-6">
                      ...
                      <div className="nk-post-by">
                        <img src="assets/images/avatar-1.jpg" alt="Hitman" className="rounded-circle" width={35} /> by <a href="#">Hitman</a> in Sep 18, 2018
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="nk-blog-post">
                  <div className="row vertical-gap">
                    ...
                    <div className="col-md-7 col-lg-6">
                      ...
                      <div className="nk-post-by">
                        <img src="assets/images/avatar-3.jpg" alt="Wolfenstein" className="rounded-circle" width={35} /> by <a href="#">Wolfenstein</a> in Aug 27, 2018
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="nk-blog-post">
                  <div className="row vertical-gap">
                    ...
                    <div className="col-md-7 col-lg-6">
                      ...
                      <div className="nk-post-by">
                        <img src="assets/images/avatar-1.jpg" alt="Hitman" className="rounded-circle" width={35} /> by <a href="#">Hitman</a> in Aug 14, 2018
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="nk-blog-post">
                  <div className="row vertical-gap">
                    ...
                    <div className="col-md-7 col-lg-6">
                      ...
                      <div className="nk-post-by">
                        <img src="assets/images/avatar-3.jpg" alt="Wolfenstein" className="rounded-circle" width={35} /> by <a href="#">Wolfenstein</a> in Jul 23, 2018
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="nk-blog-post">
                  <div className="row vertical-gap">
                    ...
                    <div className="col-md-7 col-lg-6">
                      ...
                      <div className="nk-post-by">
                        <img src="assets/images/avatar-3.jpg" alt="Wolfenstein" className="rounded-circle" width={35} /> by <a href="#">Wolfenstein</a> in Jul 3, 2018
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="nk-blog-post">
                  <div className="row vertical-gap">
                    ...
                    <div className="col-md-7 col-lg-6">
                      ...
                      <div className="nk-post-by">
                        <img src="assets/images/avatar-2.jpg" alt="Witch Murder" className="rounded-circle" width={35} /> by <a href="#">Witch Murder</a> in Jul 3, 2018
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="nk-blog-post">
                  <div className="row vertical-gap">
                    ...
                    <div className="col-md-7 col-lg-6">
                      ...
                      <div className="nk-post-by">
                        <img src="assets/images/avatar-1.jpg" alt="Hitman" className="rounded-circle" width={35} /> by <a href="#">Hitman</a> in Jul 3, 2018
                      </div>
                    </div>
                  </div>
                </div>
